...
{id:'magok',n:'01',type:'CITY DROP',title:'마곡 나이트 드롭',subtitle:'도시의 밤, 커피 한 잔의 여유',location:'마곡 르웨스트',area:'마곡',time:'데모 상시 체험',status:'체험 가능',reward:'카페 쿠폰 3,000원',premium:'카페 쿠폰 5,000원',kind:'확정 리워드',rewardMode:'guaranteed' as RewardMode,code:'SEESON-MAGOK',partner:'라이프스타일 브랜드 제휴 제안',description:'미디어아트가 켜지는 순간, 도시의 스크린이 새로운 만남의 장소가 됩니다. 현장 QR 참여 후 카페 쿠폰을 받아보세요.',note:'실제 지급 없는 무료 베타 체험입니다. 가입 후 카페 쿠폰 3,000원 수령 흐름을 체험합니다.'},
{id:'icon',n:'02',type:'THE ICON DROP',title:'손목 위의 새로운 시선',subtitle:'일상에 들어오는 특별한 오브제',location:'강남 스크린',area:'강남',time:'일정 협의 중',status:'응모 흐름 체험 가능',reward:'프리미엄 시계 무료 응모권',premium:'프리미엄 시계 무료 응모권',kind:'무료 추첨',rewardMode:'draw' as RewardMode,code:'SEESON-ICON',partner:'바이버 · 구구스 협업 후보 / 미확정',description:'프리미엄 시계를 도시의 스크린에서 만나고 무료 추첨에 참여하는 캠페인 제안입니다. 브랜드·제품·당첨 인원은 파트너 협의 후 확정합니다.',note:'실제 응모가 아닌 추첨 흐름 데모입니다. 상품·제휴·발표 일정은 아직 확정되지 않았습니다.'},
{id:'web3',n:'03',type:'WEB3 DROP',title:'도시에서 만나는 Web3',subtitle:'스크린에서 시작되는 새로운 연결',location:'강북 스크린',area:'강북',time:'일정 협의 중',status:'제휴 제안',reward:'스폰서 토큰 에어드랍',premium:'스폰서 토큰 에어드랍',kind:'에어드랍 제안',rewardMode:'draw' as RewardMode,code:'',partner:'업비트 · 빗썸 · 해외 프로젝트 후원 후보 / 미확정',description:'토큰포스트와 Web3 브랜드를 연결하는 도시형 리워드 캠페인 제안입니다. 토큰 종류·수량·지급 주체·대상 조건을 확정한 뒤 참여를 엽니다.',note:'현재 지급·지갑 연결은 제공하지 않습니다. 상장이나 가격 상승을 보장하지 않으며 거래소와 프로젝트의 계약은 미확정입니다.'},
{id:'rolex',n:'04',type:'HYPE DROP',title:'롤렉스 즉석 드롭',subtitle:'스캔 즉시 당첨 여부를 그 자리에서 확인',location:'현장 스크린 (장소 협의 중)',area:'미정',time:'일정 협의 중',status:'제휴 제안',reward:'롤렉스 서브마리너 즉석 당첨',premium:'롤렉스 서브마리너 즉석 당첨',kind:'즉석 당첨',rewardMode:'guaranteed' as RewardMode,code:'',partner:'시계 공식 판매점 · 리셀 플랫폼 협업 후보 / 미확정',description:'한정 수량의 롤렉스 서브마리너를 걸고, 스캔 즉시 당첨 여부까지 현장에서 바로 확인하는 초고가 리워드 시나리오입니다. 준비된 수량이 소진되면 응모 자체가 종료되는 방식으로, 현장의 긴장감과 화제성을 동시에 노립니다.',note:'브랜드 협업 · 실물 재고 · 법적 검토가 끝나야 실제 QR 참여가 열리는 제안 단계입니다. 확정된 수량과 발표 방식은 아직 없습니다.'},
{id:'birkin',n:'05',type:'HYPE DROP',title:'에르메스 버킨백 추첨 드롭',subtitle:'응모하고 발표를 기다리는 하이엔드 리워드',location:'장소 협의 중',area:'미정',time:'일정 협의 중',status:'제휴 제안',reward:'에르메스 버킨백 무료 응모권',premium:'에르메스 버킨백 무료 응모권',kind:'무료 추첨',rewardMode:'draw' as RewardMode,code:'',partner:'명품 편집숍 · 리셀 플랫폼 협업 후보 / 미확정',description:'에르메스 버킨백을 상품으로 건 추첨형 캠페인 제안입니다. 응모는 QR로 접수하고, 마감 후 운영팀이 추첨을 진행해 당첨자를 발표하는 방식입니다. 브랜드 · 수량 · 발표 일정은 파트너 협의 후 확정합니다.',note:'실제 응모가 아닌 시나리오 제안입니다. 브랜드 협업 · 재고 · 발표 일정은 아직 확정되지 않았습니다.'},
{id:'btc',n:'06',type:'HYPE DROP',title:'1 BTC 추첨 드롭',subtitle:'도시의 스크린이 거는 가장 뜨거운 응모',location:'장소 협의 중',area:'미정',time:'일정 협의 중',status:'제휴 제안',reward:'1 BTC 무료 응모권',premium:'1 BTC 무료 응모권',kind:'에어드랍 추첨',rewardMode:'draw' as RewardMode,code:'',partner:'거래소 · Web3 프로젝트 후원 후보 / 미확정',description:'1 BTC를 상품으로 건 추첨형 캠페인 제안입니다. 응모는 QR로 접수하고, 마감 후 운영팀이 추첨을 진행해 당첨자를 발표합니다. 지갑 연결이나 실제 코인 지급은 제공하지 않으며, 지급 방식은 파트너 · 거래소 협의 후 확정합니다.',note:'현재 지갑 연결 · 지급은 제공하지 않습니다. 상장이나 가격 상승을 보장하지 않으며 거래소 · 프로젝트와의 계약은 미확정입니다.'}
];
