...
// TEMP 2026-09-11: code is a one-off internal test value so the full winner/shipping flow can be
// click-tested end-to-end against real Supabase RPCs. Matching row must exist in Supabase `campaigns`
// (see 08_Supabase_백엔드_설정.md §7 test-run notes). REVERT code back to '' after the test.
{id:'birkin',n:'03',type:'HYPE DROP',category:'bag' as Category,title:'에르메스 버킨백 추첨 드롭',subtitle:'응모하고 발표를 기다리는 하이엔드 리워드',location:'장소 협의 중',area:'미정',time:'일정 협의 중',status:'제휴 제안',reward:'에르메스 버킨백 무료 응모권',premium:'에르메스 버킨백 무료 응모권',qty:'1개 한정 · 응모 추첨',kind:'무료 추첨',rewardMode:'draw' as RewardMode,code:'SEESON-TEST-BIRKIN',partner:'명품 편집숍 · 리셀 플랫폼 협업 후보 / 미확정',description:'에르메스 버킨백을 상품으로 건 추첨형 캠페인 제안입니다. 응모는 QR로 접수하고, 마감 후 운영팀이 추첨을 진행해 당첨자를 발표하는 방식입니다. 브랜드 · 수량 · 발표 일정은 파트너 협의 후 확정합니다.',note:'실제 응모가 아닌 시나리오 제안입니다. 브랜드 협업 · 재고 · 발표 일정은 아직 확정되지 않았습니다.'},
